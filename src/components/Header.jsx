        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <motion.img
              ...
              className="w-10 min-w-[40px] h-10 h-min-[40px] drop-shadow-xl cursor-pointer rounded-full"
              alt="userprofile"
              onClick={login}
            />
            {isMenu && (
              ...
              >
                {user && user.email === "bharathraj7302@gmail.com" && (
                  <Link to={"./createItem"}>
